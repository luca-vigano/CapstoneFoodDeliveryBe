...
public class CartService {
    ...
    public CartItem addItemToCart(AddCartItemRequest req, User currentUser) throws Exception {
    ...
    public Cart removeItemFromCart(Long cartItemId, User currentUser) throws Exception {
        Cart cart = cartRepository.findByCustomerId(currentUser.getId());
